    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notificar_a', models.CharField(choices=[('todos', 'Todos los usuarios'), ('superuser', 'Solo el Administrador Principal')], default='todos', max_length=10, verbose_name='Habilitar Notificaciones para')),

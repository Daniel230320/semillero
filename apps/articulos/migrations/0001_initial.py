# Generated by Django 5.1.5 on 2025-06-08 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigoarticulo', models.CharField(help_text='Código interno del producto', max_length=15, unique=True, verbose_name='Código de Producto')),
                ('codigo_barras', models.CharField(blank=True, help_text='Código de barras (EAN-13 generado o escaneado)', max_length=13, null=True, unique=True)),
                ('imagen_barras', models.ImageField(blank=True, null=True, upload_to='barcodes/', verbose_name='Imagen de Código de barras')),
